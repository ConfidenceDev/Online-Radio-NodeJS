...
const goLive = document.getElementById("stream_btn")
const sendBtn = document.getElementById("send_btn")
const chatField = document.getElementById("message_input")
const streamerBtn = document.getElementById("streamer_profile_btn")
...
const timer = document.getElementById("prompt_count")
...
function loadModal(loc) {
  ...
  //window.location.assign(`${path}public/#${loc}`)
  if (path.includes("#")) {
